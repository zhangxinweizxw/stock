...
func (this *Stock_Day_K) GetDaykJC(sc string) string {
	...
	bulid := this.Db.Select("f12").
		From(this.TableName).
		Where(fmt.Sprintf("f12='%v'", sc)).
		Where(" dayK30 > dayK60 AND dayK20 > dayK30 AND day5zdf < 8  AND f8 >0.8 AND f8< 8 AND f10 >0.5 AND f10 <8 AND f3 > -0.8 AND f3 <3 AND f2 < 58 AND f9 <28 AND f9 >5 AND f62 >10000000 AND f2 >f17 AND dayK10 > dayK20 AND dayK5 < dayK10").
